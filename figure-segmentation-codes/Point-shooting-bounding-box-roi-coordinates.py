# -*- coding: utf-8 -*-
"""
Created on Sun July 20 22:19:53 2020
...
def point_shooting(data, result_location):
    ...
    for i in range(len(data_list)):
        ...
        cv2.drawContours(img_or, contours, -1, (0, 255, 0), 4)
        # cv2.imshow('Contours', img_or)
